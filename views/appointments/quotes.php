...
<div class="container">
    ...
    <div class="row">
        <?php
        include_once('../../core/news/CitasController.php');

        $citas = obtenerCitas(); // Función para obtener citas desde el controlador
                ...
                <div class='card shadow-sm'>
                    <div class='card-body'>
                        ...
                        <div class='d-flex justify-content-between align-items-center'>
                            <a href='verCita.php?id=" . htmlspecialchars($cita['id']) . "' class='btn btn-outline-primary btn-sm'>Ver</a>
                            <a href='editarCita.php?id=" . htmlspecialchars($cita['id']) . "' class='btn btn-outline-warning btn-sm'>Editar</a>
